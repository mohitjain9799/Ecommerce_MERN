...
import videoCover from "../assets/videos/covers.mov";
...
const Home = () => {
  ...
  const coverMessage =
    "Discover elegant, handcrafted jewelry that exudes timeless beauty. Explore unique collections of rings, necklaces, bracelets, and earrings designed to complement every style. Experience luxury with premium materials and exquisite craftsmanship, perfect for special occasions or everyday wear.".split(
      " "
    );
